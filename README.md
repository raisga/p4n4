...
- **Rapid IoT prototyping** — use the hardware reference designs in `core/hw`, flash a board, point it at Mosquitto, and have a full observability stack running in minutes with `p4n4 up`.
